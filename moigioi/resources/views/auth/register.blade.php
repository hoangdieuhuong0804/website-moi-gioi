                ...
                <form action="{{ route('registering') }}" method="post">
                    ...
                    <div class="mt-2">
                        <div class="form-check form-check-inline">
                            <input type="radio" id="customRadio3" name="role" class="form-check-input" value="1" checked>
                            <label class="form-check-label" for="customRadio3">Applicant</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" id="customRadio4" name="role" class="form-check-input" value="2">
                            <label class="form-check-label" for="customRadio4">HR</label>
                        </div>
                    </div>
